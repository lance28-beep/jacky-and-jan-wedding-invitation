            ...
            <div className="max-w-6xl mx-auto space-y-16">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                  {["Jeanie Velayo", "Teresa Nepomuceno", "Engr. Joenil Lavadia", "Femy Delator", "Tara Talafer", "Ariel Amedo", "Gemma De los Santos", "Dra. Gladys Pailano Tan", "Marivic Dormido", "Brian Amadora", "Lynee Penaflor", "Engr. Leo Pahilanga", "Rene Pailano", "Julie Peruelo", "Sampaguita Repique", "Margarita Gonschorek", "Daisy Carmona", "Edwin Escanuela", "Connie Franco Gallego", "Bonifacio Alvarez Jr.", "Engr. Jeffrey Alvarez","Elvie Ermac Robertson","Judith Alvarez Callaghan","Nilda Alabarta"].map((name, idx) => (
